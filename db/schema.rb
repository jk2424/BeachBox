...
ActiveRecord::Schema.define(version: 2018_05_12_010717) do
  ...
  create_table "OrderItem", force: :cascade do |t|
    ...
    t.index ["order_id"], name: "index_OrderItem_on_order_id"
    t.index ["product_id"], name: "index_OrderItem_on_product_id"
  end

  create_table "OrderStatus", force: :cascade do |t|
    t.string "name"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end
